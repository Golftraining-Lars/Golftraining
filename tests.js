...
const COVERAGE_BASELINE_FUNCS = (
    ...
    "satTilePx satTileRes selOpts sgDashHtml sgDisasterHtml sparkline strkDown strkZoomAt" +" "+
    "strkZoomBtn swDaysSince swNormTag targetFor teeNames thinRing weatherByGeo" +" "+
...
try {
  ...
  const namen = ["STRAT","clubPick","playsLike","pinPoint","geoDist","playMapBox",
                 ...
                 "sgWeakest","sgFmt","sgClass","clubMeasured","sgDrillHint"];
  const epilog = "\n;globalThis.__T={" +
...
group("Strokes Gained — die Kennzahl, die sagt WO Schläge verlorengehen");
{
  ...
  if (typeof mid === "function") {
    ...
    ok("Text ohne Zahl → null", mid("Gimme") === null);
  }
