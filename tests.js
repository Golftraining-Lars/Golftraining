...
const COVERAGE_BASELINE_FUNCS = (
    ...
    "satTilePx satTileRes selOpts sparkline strkDown strkZoomAt strkZoomBtn swDaysSince" +" "+
    "swNormTag targetFor teeNames thinRing weatherByGeo weatherEffectHtml wikiCountCat" +" "+
